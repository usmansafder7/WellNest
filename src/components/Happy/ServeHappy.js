...
export const ServeHappy = () => {
  ...
  return (
    <div className="display flex flex-col items-center justify-center my-12">
      <h1 className="max-w-2xl mb-4 text-3xl text-[#B32800] font-extrabold tracking-tight leading-none md:text-4xl xl:text-5xl">
      ...
      <div className="flex flex-wrap gap-x-12 md:gap-x-20 gap-y-8 display justify-start mx-48 md:mx-80 my-12">
        <div className="h-64 w-80 bg-[#FBDD00] border rounded-lg border-[#B32800]">
          <img src={employer} className="h-40 mx-20 my-4" alt="" />
          <p className="max-w-2xl my-4 text-lg text-center text-[#B32800] font-bold tracking-tight leading-none md:text-xl xl:text-2xl">
