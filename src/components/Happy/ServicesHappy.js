...
export const ServicesHappy = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 mb-24">
      <h2 className="text-5xl text-[#B32800] text-center font-extrabold mb-12">{selectedContent.heading}</h2>
      ...
      <div className='flex gap-x-16'>
        ...
        <div className="hidden lg:mt-0 lg:col-span-4 lg:flex">
          <img src={happyPeople} alt="mockup" />
        </div>
      </div>
    </div>
  );
