...
import heroImage from "../../assets/sad hero image.png";
import { LanguageContext } from '../../context/LanguageContext';

export const SadHero = () => {
    ...
    <section className="bg-white">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-4 text-4xl text-[#59D7EE] font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">
            {selectedContent.heading}
          </h1>
          <p className="max-w-2xl mb-6 font-light text-gray-900 lg:mb-8 md:text-lg lg:text-xl">
            {selectedContent.description}
          </p>
          <a href="https://github.com/ayeshag7" className="inline-flex bg-[#53DFD1] items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-gray-900 rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300">
