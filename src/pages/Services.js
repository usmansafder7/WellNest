...
export const Services = () => {
  ...
  const content = {
    English: {
      ...
      founded: "Founded",
      foundedDesc: "Founded in [Year], WellNest was born out of a deep understanding of the challenges faced by organizations in maintaining employee well-being.",
      users: "400k Users",
      usersDesc: "Since our inception, WellNest has partnered with numerous organizations to enhance their workplace wellness programs.",
      missionTitle: "Our Mission",
      missionDesc1: "Our mission is to provide personalized mental health support to employees, helping them to achieve their best selves.",
      missionDesc2: "We aim to create a healthier and more productive workplace through innovative solutions and comprehensive mental fitness programs.",
      team: "Team",
      teamDesc: "Our team is dedicated to empowering employees through personalized wellness programs and data-driven insights.",
      board: "Board",
      boardDesc: "Our board members are committed to bridging the gap between mental health and workplace productivity.",
      press: "Press",
      pressDesc: "We have been featured in numerous publications for our innovative approach to employee well-being."
    },
    Urdu: {
      about: "ہمارے بارے میں",
      title: "ایک صحت مند کام کی جگہ کے لیے ملازم کی فلاح و بہبود کو مضبوط بنانا",
      description: "WellNest میں، ہمارا مشن دنیا بھر میں ملازمین کو ذاتی، ڈیجیٹل ذہنی صحت کی مدد فراہم کر کے کام کی جگہ کی تندرستی میں انقلاب لانا ہے۔ ہمیں یقین ہے کہ ایک صحت مند، خوشحال افرادی قوت ایک زیادہ پیداواری اور مشغول افرادی قوت ہے۔ ذہنی تندرستی کے لیے اختراعی حل اور ایک جامع نقطہ نظر کے ذریعے، ہم افراد کو ذاتی اور پیشہ ورانہ طور پر اپنے بہترین خود کو حاصل کرنے کے لیے بااختیار بنانے کا ارادہ رکھتے ہیں۔",
      founded: "قیام",
      foundedDesc: "WellNest کی بنیاد [Year] میں رکھی گئی تھی، جو ملازمین کی بہبود کو برقرار رکھنے میں تنظیموں کو درپیش چیلنجوں کی گہری تفہیم سے پیدا ہوئی تھی۔",
      users: "400k صارفین",
      usersDesc: "ہماری ابتدا سے، WellNest نے متعدد تنظیموں کے ساتھ شراکت داری کی ہے تاکہ ان کے کام کی جگہ کی فلاح و بہبود کے پروگراموں کو بڑھایا جا سکے۔",
      missionTitle: "ہمارا مشن",
      missionDesc1: "ہمارا مشن ملازمین کو ذاتی ذہنی صحت کی مدد فراہم کرنا ہے، جس سے انہیں اپنے بہترین خود کو حاصل کرنے میں مدد ملے۔",
      missionDesc2: "ہم اختراعی حل اور جامع ذہنی تندرستی کے پروگراموں کے ذریعے ایک صحت مند اور زیادہ پیداواری کام کی جگہ بنانے کا ارادہ رکھتے ہیں۔",
      team: "ٹیم",
      teamDesc: "ہماری ٹیم ذاتی فلاح و بہبود کے پروگراموں اور ڈیٹا سے چلنے والی بصیرت کے ذریعے ملازمین کو بااختیار بنانے کے لیے وقف ہے۔",
      board: "بورڈ",
      boardDesc: "ہمارے بورڈ کے اراکین ذہنی صحت اور کام کی جگہ کی پیداوری کے درمیان خلا کو ختم کرنے کے لیے پرعزم ہیں۔",
      press: "پریس",
      pressDesc: "ہمیں ملازمین کی فلاح و بہبود کے لیے ہمارے اختراعی نقطہ نظر کے لیے متعدد اشاعتوں میں نمایاں کیا گیا ہے۔"
    }
  };
